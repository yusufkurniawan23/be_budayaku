...
<head>
    ...
    <title>{{ $budaya->nama_objek }} - Dinas Kebudayaan Tulungagung</title>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <div class="img-box">
                        @if ($budaya->foto)
                            <img src="{{ asset('storage/' . $budaya->foto) }}" alt="{{ $budaya->nama_objek }}" class="img-fluid">
                        @else
                ...
                <div class="col-md-6">
                    <div class="detail-content">
                        <h2>{{ $budaya->nama_objek }}</h2>
                        <p class="text-muted"><strong>Kategori:</strong> {{ $budaya->category->name ?? 'Tidak Ada' }}</p>
                        <p class="text-muted"><strong>Tanggal:</strong> {{ \Carbon\Carbon::parse($budaya->tanggal)->translatedFormat('d F Y') }}</p>
                        <hr>
